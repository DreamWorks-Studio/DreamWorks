  ...
  return (
      <div className='flex flex-col min-h-screen bg-white'>
          <div className='flex flex-col items-center justify-center container
            mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden pt-40'>
              <h1 className='text-2xl sm:text-4xl font-bold mb-5 pb-5  text-amber-600'>About
              ...
              <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
                  ...
                  <div className='flex flex-col items-center md:items-start mt-10 text-gray-950'>
