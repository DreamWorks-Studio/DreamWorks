          ...
          >
            {currentUser ? (
              ...
              <li
                ...
                className="hidden md:block bg-transparent text-amber-500 hover:text-white px-5 py-2 border-2 border-amber-500 hover:border-white rounded-full cursor-pointer"
              >
                Sign Up
              </li>
            )}
